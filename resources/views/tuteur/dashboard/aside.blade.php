    ...
    <nav class="navbar navbar-expand-sm navbar-default">
        ...
        <div id="main-menu" class="main-menu collapse navbar-collapse">
            <ul class="nav navbar-nav">
                <li class="active">
                    <a href="/tuteur/dashboard"> <i class="menu-icon fa fa-dashboard"></i>Tableau de bord </a>
                </li>
                ...
                <li class="menu-item">
                    <a href="/tuteur/dashboard/rapport"> <i class="menu-icon fa fa-laptop"></i>Rapports</a>
                </li>
            </ul>
        </div><!-- /.navbar-collapse -->
    </nav>
